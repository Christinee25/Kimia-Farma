...
CREATE TABLE
  rakamin-kf-analytics-427606.kimia_farma.kf_tabel_analisa AS
...
WITH
  ...
  FROM
    rakamin-kf-analytics-427606.kimia_farma.kf_final_transaction t
  ...
  LEFT JOIN
    rakamin-kf-analytics-427606.kimia_farma.kf_kantor_cabang c
  ON
    t.branch_id = c.branch_id
  -- dan dengan tabel produk untuk menambahkan kolom nama produk yang tidak terdapatpada tabel transaksi
  LEFT JOIN
    rakamin-kf-analytics-427606.kimia_farma.kf_product p
  ON
